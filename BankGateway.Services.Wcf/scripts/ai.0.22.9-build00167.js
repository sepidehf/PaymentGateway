        ...
        var Sender = (function () {
            ...
            Sender.prototype.send = function (envelope) {
                ...
                try {
                    ...
                    if (this._getSizeInBytes(this._buffer) + payload.length > this._config.maxFileSizeInBytes()) {
                        this.triggerSend();
                    }
                ...
                try {
                    if (!this._config.disableTelemetry()) {
                        if (this._buffer.length) {
                            var File = this._config.emitLineDelimitedJson() ?
                                this._buffer.join("\n") :
                                "[" + this._buffer.join(",") + "]";
                            this._sender(File, isAsync, this._buffer.length);
                        }
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    maxFileSizeInBytes: function () { return _this.config.maxFileSizeInBytes; },
                    maxFileInterval: function () { return _this.config.maxFileInterval; },
    ...
    (function (ApplicationInsights) {
        ...
        var Initialization = (function () {
            ...
            Initialization.getDefaultConfig = function (config) {
                ...
                config.maxFileSizeInBytes = config.maxFileSizeInBytes > 0 ? config.maxFileSizeInBytes : 1000000;
                config.maxFileInterval = !isNaN(config.maxFileInterval) ? config.maxFileInterval : 15000;
